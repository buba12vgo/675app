...
**Cómo usar la app:** en https://675app.vercel.app pulsa **Cómo funciona la app** (también está en Opciones cuando ya has entrado). La guía cubre el aspecto actual (pista, modo claro/oscuro) y el uso de cada pantalla.
